    ...
    <main>
        <section>
            ...
            <form action="./index.php" method="POST">
                <header class="mb-4">
                    <h4 class="h4">Admin Log in</h4>
                </header>
                <div>
                    <label for="">Username</label>
                    <input type="text" name="username" id="" placeholder="Enter admin ID" required>
                </div>
                <div>
                    <label for="">Password</label>
                    <input type="password" name="password" id="" placeholder="Enter admin password" required>
                </div>
                <input type="submit" value="Log in" name="admin-login">
                ...
                <div class="d-flex justify-content-center gap-5">
                    <a href="../" class="text-light">&larr; Student </a>
                </div>
            </form>
        </section>
    </main>
